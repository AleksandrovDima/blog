...
Route::group(['prefix' => 'posts'], function () {
    Route::get('/popular', \App\Http\Controllers\Post\Popular\IndexController::class)->name('post.popular.index');
...
Route::group(['prefix' => 'personal', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'posts'], function () {
        Route::get('/', \App\Http\Controllers\Personal\Post\IndexController::class)->name('personal.post.index');
        Route::get('/create', \App\Http\Controllers\Personal\Post\CreateController::class)->name('personal.post.create');
        Route::post('/', \App\Http\Controllers\Personal\Post\StoreController::class)->name('personal.post.store');
        Route::get('/{post}', \App\Http\Controllers\Personal\Post\ShowController::class)->name('personal.post.show');
        Route::get('/{post}/edit', \App\Http\Controllers\Personal\Post\EditController::class)->name('personal.post.edit');
        Route::patch('/{post}', \App\Http\Controllers\Personal\Post\UpdateController::class)->name('personal.post.update');
        Route::delete('/{post}', \App\Http\Controllers\Personal\Post\DeleteController::class)->name('personal.post.delete');
    });
