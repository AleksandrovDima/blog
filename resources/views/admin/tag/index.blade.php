                                    ...
                                    @foreach($tags as $tag)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.tag.show', $tag->id) }}" class="text-black-50" title="посмотреть"><i class="far fa-eye"></i></a>
                                            </td>
                                            <td class="text-center">
                                                <a href="{{ route('admin.tag.edit', $tag->id) }}" class="text-black-50" title="редактировать"><i class="fas fa-pencil-alt"></i></a>
                                            </td>
                                            <td class="text-center">
